...
\begin{itemize}
    ...
    \item \textbf{AnonymousPermissionMaker:} creates new anonymous permission and handles unsubscription request.
    \item \textbf{IndividualPermissionMaker:}
    \item \textbf{AnonymousPermissionService:} %gestisce le  anonime
    \item \textbf{IndividualPermissionService:} %gestisce le individual
    \item \textbf{IndividualDataService:} %Accede al db e elabora i dati per mandarli in uscita
    \item \textbf{AnonymousDataService:} %Accede al db e elabora i dati per mandarli in uscita
\end{itemize}

\begin{sidewaysfigure}[h!]
    \centering
    \includegraphics[width=\linewidth]{Component-Data4Help}
...
\begin{itemize}
    %AutomatedSOS
    \item \textbf{MonitorStatusService:}
    \item \textbf{LearnThresholdsService:}
    \item \textbf{EmergencyService:}
\end{itemize}
...
\begin{itemize}    
    %Track4Run
    \item \textbf{RunCreationService:} %creazione corsa
    \item \textbf{RunManagementService:} %Gestione pre corsa(Aggiunta partecipanti)
    \item \textbf{RunTrackingService:} %Gestione durante la corsa
    \item \textbf{RunWatchService:} %Gestione spettatori durante la corsa
\end{itemize}
