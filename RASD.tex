\documentclass[a4paper]{article}
    ...
    \begin{enumerate}[label*=\bf{G.\arabic*}]
        ...
        \begin{enumerate}
            ...
            \item [R.12] Users can choose a run and register to it as a runners.
  % NON-FUNCTIONAL         \item [R.12] Users can choose to see the available runs filtering them by city and/or date. 
            \item [R.13] The system saves the enrolled users as runners and keeps track of the association with the run event.
        \end{enumerate}
